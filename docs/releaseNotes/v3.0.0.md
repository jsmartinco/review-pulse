...
| Optional six-model track | Matched target-agnostic GRU trainer, artifact, predictor and evaluator under #94 | CNN #95 and supplemental integration #96 |
...
- TF-IDF, the target-agnostic LSTM and the optional target-agnostic GRU explicitly report that aspect-specific token evidence is unsupported.
