...
| Optional six-model track | Matched GRU/TextCNN candidates plus explicit verified training, evaluation, app and supplemental-output mode under #94–#96 | Final same-commit result review |
...
- the current full-suite result on the #96 integration branch is **265 passed, 8 skipped**.
