...
- the current full-suite result on the #96 integration branch is **266 passed, 8 skipped**.
...
Completed foundation and evaluation: issues #73–#87, #91, #94 and #95. Issue #96 is implemented and verified on its review branch.

Open release path:

1. [#96](https://github.com/lfariabr/review-pulse/issues/96) — review and merge the verified supplemental six-model path.
