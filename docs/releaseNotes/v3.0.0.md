...
The verified #94 candidate reached 0.6750 full-test accuracy and 0.4603 macro-F1, versus 0.6688 and 0.4326 for the #84 LSTM. On the mixed-polarity subset it was slightly weaker (0.4079 accuracy, 0.3156 macro-F1 versus 0.4167 and 0.3264). It used 10.31% fewer parameters and trained 17.83% faster in the recorded CPU runs. These remain candidate observations until #96 regenerates the supplemental six-model comparison from one frozen commit.
