...
- DistilBERT token attribution or attention visualisation is tracked in issue [#85](https://github.com/lfariabr/review-pulse/issues/85).
...
- the current full-suite result on this candidate branch is **233 passed, 8 skipped**.
...
1. [#84](https://github.com/lfariabr/review-pulse/issues/84) — merge the reviewed four-model comparison and regenerate final evidence.
2. [#85](https://github.com/lfariabr/review-pulse/issues/85) — complete indicative token-evidence views.
3. [#88](https://github.com/lfariabr/review-pulse/issues/88) — write the A3 implementation report from verified outputs.
4. [#89](https://github.com/lfariabr/review-pulse/issues/89) — verify a clean install, assemble the package and create the v3.0.0 tag.
