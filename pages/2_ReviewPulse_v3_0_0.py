...
st.info("Enter one or more aspects manually. Review-only models intentionally receive only the review; ATAE-LSTM and DistilBERT receive the review-and-aspect pair.")
    ...
    try:
        ...
        for result in results:
            ...
            if evidence:
                ...
                st.dataframe(evidence["tokens"], use_container_width=True, hide_index=True)
        st.caption("Token evidence is only shown for supported attention/attribution-capable models.")
